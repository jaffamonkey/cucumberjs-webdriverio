...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./test/step_definitions/given.js', './test/step_definitions/when.js', './test/step_definitions/then.js'],   // <string[]> (file/dir) require files before executing features
